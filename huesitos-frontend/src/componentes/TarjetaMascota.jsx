...
const TarjetaMascota = ({ mascota, onVerHistorial }) => {
  const saludBadge = mascota.proximaVacuna 
    ? <Etiqueta color="amarillo" text="Próxima Vacuna">{mascota.proximaVacuna}</Etiqueta>
    : <Etiqueta color="verde" text="Saludable">Saludable</Etiqueta>;
      ...
      <div onClick={onVerHistorial} className="flex items-center p-4 gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            <Etiqueta color="slate" text="Adulto">{mascota.edad || "N/A"} años</Etiqueta>
            {saludBadge}
          </div>
        </div>
