          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
            {mascotas.map((mascota) => {
              ...
              return (
                <div
                  key={mascota.id}
                  className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/60 dark:border-slate-800 shadow-sm hover:shadow-xl hover:shadow-sky-500/8 dark:hover:shadow-sky-500/5 hover:border-sky-200/80 dark:hover:border-sky-900/60 transition-all duration-300 group overflow-hidden flex flex-col"
                >
                  {/* Foto / Avatar grande */}
                  <div className="relative w-full aspect-[4/3] bg-gradient-to-tr from-sky-100 to-cyan-50 dark:from-sky-950/60 dark:to-slate-900 overflow-hidden shrink-0">
                    ...
                    {/* Fallback inicial — oculto si hay foto válida */}
                    <div
