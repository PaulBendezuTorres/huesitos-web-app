...
Última actualización: 2026-06-15 (Compresión y reorganización de memoria)
...
- [x] Carrusel 16:9 en `SeccionCampanas`: rotación automática (6s), flechas, puntos indicadores. Integrado en `Portada` y `ClienteInicio`.
- [x] Banners split-screen en PC: imagen 75% izquierda + contenido clínico 25% derecha (título, descripción, precio, botón "Adquiere tu Promo"). Responsive en móvil.
...
- [x] Portales migrados: `TableroAdministrador`, `TableroCliente`, `TableroRecepcionista`, `TableroVeterinario` usan `PlantillaTablero`.
