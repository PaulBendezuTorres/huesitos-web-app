...
- [x] Creados la entidad `Dueno` y los repositorios `UsuarioRepositorio` y `DuenoRepositorio`.

## 📌 Estado Actual de los Componentes
- **Backend (Spring Boot)**: Configurado con JPA, Security, JWT y repositorios básicos. Creadas entidades `Usuario` y `Dueno`.
