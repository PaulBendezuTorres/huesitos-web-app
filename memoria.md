...
- [x] **Banners de Campaña Limpios en Cliente e Inicio Público (16:9)**:
  ...
  - Si una campaña cuenta con una imagen de banner cargada (`tieneImagen` es verdadero), ahora se renderiza en un diseño dividido (split-screen) en PC: la imagen limpia ocupa el 75% de ancho en la parte izquierda sin distorsiones ni cortes de información, y el contenido de la campaña (título, descripción, precio del paquete, cantidad de servicios, y un botón de llamada a la acción "Adquiere tu Promo" con estilo veterinario) se sitúa al lado derecho (ocupando el 25% de ancho). En móviles, se renderiza la imagen arriba ocupando un aspect-video y el contenido clínico abajo de manera fluida, limitando el alto en PC para evitar banners excesivamente grandes.
